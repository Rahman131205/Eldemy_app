  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./profile/notifications.page').then(m => m.NotificationsPage)
      },
      {
        path: 'profile/privacy',
        loadComponent: () => import('./profile/privacy.page').then(m => m.PrivacyPage)
      },
      {
        path: 'profile/help',
        loadComponent: () => import('./profile/help.page').then(m => m.HelpPage)
      },
      {
      ...
      {
        path: 'course-detail/:courseId/material/:materialId',
